...
public class TurtleMenu extends Menu {

    public TurtleMenu(PlayerMenuUtility playerMenuUtility) {
        super(playerMenuUtility);
    }

    @Override
    public String getMenuName() {
        return "Turtle Helmet Enchantments!";
    }
    ...
    public void handleMenu(InventoryClickEvent e) {
        ...
        switch (rawSlot) {
            ...
            case 24:
                ...
                break;
            case 30:
                new RespirationMenu(playerMenuUtility).open();
                playerMenuUtility.setPreviousMenu(this);
                break;
            case 31:
                new AquaAffinityMenu(playerMenuUtility).open();
                playerMenuUtility.setPreviousMenu(this);
                break;
            case 32:
    ...
    public void setMenuItems() {
        ...
        respirationMeta.setDisplayName(ChatColor.GOLD + "Respiration");
        respirationMeta.setLore(Arrays.asList(ChatColor.GRAY + "Respiration"));
        ...
        aquaAffinityMeta.setLore(Arrays.asList(ChatColor.GRAY + "Aqua Affinity"));
        ...
        inventory.setItem(30, respiration);
        inventory.setItem(31, aquaAffinity);
        inventory.setItem(32, thorns);
