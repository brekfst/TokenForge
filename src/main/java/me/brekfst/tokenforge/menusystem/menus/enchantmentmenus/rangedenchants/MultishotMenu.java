...
public class MultishotMenu extends Menu {

    ItemStack selectedTool;

    private Map<Player, Map<Enchantment, Integer>> selectedEnchantments = new HashMap<>();

    public MultishotMenu(PlayerMenuUtility playerMenuUtility) {
        super(playerMenuUtility);
    }

    @Override
    public String getMenuName() {
        return "Multishot Enchantments!";
    }
    ...
    public void handleMenu(InventoryClickEvent event) {
        ...
        switch (event.getRawSlot()) {
            case 22:
                EnchantmentUtility.selectEnchantment(player, playerMenuUtility, "multishot", 1);
                break;
    ...
    public void setMenuItems() {
        ...
        multishotMeta.setLore(Arrays.asList(ChatColor.GRAY + "Free"));
        ...
        inventory.setItem(22, multishot);
