...
import me.brekfst.tokenforge.menusystem.menus.enchantmentmenus.armourenchants.ElytraProtectionMenu;
...
public class ElytraMenu extends Menu {
    ...
    public ElytraMenu(PlayerMenuUtility playerMenuUtility) {
        super(playerMenuUtility);
    }

    @Override
    public String getMenuName() {
        return "Elytra Enchantments!";
    }
    ...
    public void handleMenu(InventoryClickEvent e) {
        ...
        switch (rawSlot) {
            ...
            case 22:
                ...
                break;
            case 23:
                new ElytraProtectionMenu(playerMenuUtility).open();
                playerMenuUtility.setPreviousMenu(this);
                break;
            case 36:
    ...
    public void setMenuItems() {
        ...
        inventory.setItem(23, protection);
