...
import me.brekfst.tokenforge.menusystem.menus.enchantmentmenus.rangedenchants.MultishotMenu;
import me.brekfst.tokenforge.menusystem.menus.enchantmentmenus.rangedenchants.PiercingMenu;
import me.brekfst.tokenforge.menusystem.menus.enchantmentmenus.rangedenchants.QuickChargeMenu;
...
public class CrossbowMenu extends Menu {

    public CrossbowMenu(PlayerMenuUtility playerMenuUtility) {
        super(playerMenuUtility);
    }

    @Override
    public String getMenuName() {
        return "Crossbow Enchantments";
    }
    ...
    public void handleMenu(InventoryClickEvent e) {
        ...
        switch (rawSlot) {
            ...
            case 21:
                ...
                break;
            case 22:
                new PiercingMenu(playerMenuUtility).open();
                playerMenuUtility.setPreviousMenu(this);
                break;
            case 23:
                new QuickChargeMenu(playerMenuUtility).open();
                playerMenuUtility.setPreviousMenu(this);
                break;
            case 24:
                new MultishotMenu(playerMenuUtility).open();
                playerMenuUtility.setPreviousMenu(this);
                break;
            case 36:
    ...
    public void setMenuItems() {
        ...
        piercingMeta.setDisplayName(ChatColor.GOLD + "Piercing");
        piercingMeta.setLore(Arrays.asList(ChatColor.GRAY + "Piercing"));
        ...
        quickChargeMeta.setDisplayName(ChatColor.GOLD + "Quick Charge");
        quickChargeMeta.setLore(Arrays.asList(ChatColor.GRAY + "Quick Charge"));
        ...
        multishotMeta.setDisplayName(ChatColor.GOLD + "Multishot");
        multishotMeta.setLore(Arrays.asList(ChatColor.GRAY + "Multishot"));
        ...
        inventory.setItem(22, piercing);
        inventory.setItem(23, quickCharge);
        inventory.setItem(24, multishot);
