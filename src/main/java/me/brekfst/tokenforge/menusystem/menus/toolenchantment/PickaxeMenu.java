...
public class PickaxeMenu extends Menu {
    ...
    public PickaxeMenu(PlayerMenuUtility playerMenuUtility) {
        super(playerMenuUtility);
    }

    @Override
    public String getMenuName() {
        return "Pickaxe Enchantments!";
    }
    ...
    public void setMenuItems() {
        ...
        silkTouchMeta.setLore(Arrays.asList(ChatColor.GRAY + "Silk Touch"));
        ...
        inventory.setItem(23, fortune);
        inventory.setItem(24, silkTouch);
