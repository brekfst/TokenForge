...
public class SilkTouchMenu extends Menu {

    ItemStack selectedTool;

    private Map<Player, Map<Enchantment, Integer>> selectedEnchantments = new HashMap<>();

    public SilkTouchMenu(PlayerMenuUtility playerMenuUtility) {
        super(playerMenuUtility);
    }

    @Override
    public String getMenuName() {
        return "Silk Touch Enchantments!";
    }
    ...
    public void handleMenu(InventoryClickEvent event) {
        ...
        switch (event.getRawSlot()) {
            case 22:
                EnchantmentUtility.selectEnchantment(player, playerMenuUtility, "silk touch", 1);
                break;
    ...
    public void setMenuItems() {
        ...
        silkTouchMeta.setDisplayName(ChatColor.GOLD + "Silk Touch");
        silkTouchMeta.setLore(Arrays.asList(ChatColor.GRAY + "Free"));
        ...
        inventory.setItem(22, silkTouch);
