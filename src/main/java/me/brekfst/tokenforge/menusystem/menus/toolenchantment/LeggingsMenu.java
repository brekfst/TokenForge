...
public class LeggingsMenu extends Menu {
    ...
    public LeggingsMenu(PlayerMenuUtility playerMenuUtility) {
        super(playerMenuUtility);
    }

    @Override
    public String getMenuName() {
        return "Leggings Enchantments!";
    }
    ...
    public void handleMenu(InventoryClickEvent e) {
        ...
        switch (rawSlot) {
            ...
            case 23:
                ...
                break;
            case 24:
                new SwiftSneakMenu(playerMenuUtility).open();
                playerMenuUtility.setPreviousMenu(this);
                break;
            case 36:
    ...
    public void setMenuItems() {
        ...
        swiftSneakMeta.setDisplayName(ChatColor.GOLD + "Swift Sneak");
        swiftSneakMeta.setLore(Arrays.asList(ChatColor.GRAY + "Swift Sneak"));
        ...
        inventory.setItem(24, swiftSneak);
